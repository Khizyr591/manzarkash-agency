  ...
  const navLinks: NavLink[] = [
    ...
    { label: "Portfolio", href: "/portfolio", num: "05" },
    {
      ...
      children: [
        ...
        { label: "Video Ads Production", href: "/services/production-video-ads", desc: "Direct-response campaigns, shoots & UGC" },
        { label: "Product Photography & Visuals", href: "/services/product-visuals", desc: "Studio-lit catalog, macro & lifestyle shoots" },
