...
export default function AboutFaq() {
  const faqs: FaqItem[] = [
    ...
    {
      q: "How do you manage international client campaigns and timezones?",
      a: "Our core engineering and creative studio is based in Karachi (PKT +5), but we run operations synchronized with clients in the UK (BST +1), Europe (CEST +2), and the Gulf (GST +1). We structure asynchronous updates via shared boards and schedule live video synchronization syncs to guarantee seamless delivery across all timezones.",
    },
    {
