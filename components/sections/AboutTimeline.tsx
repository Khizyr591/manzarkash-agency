...
export default function AboutTimeline() {
  const milestones: Milestone[] = [
    ...
    {
      year: "2025/2026",
      tag: "GLOBAL LANDSCAPE",
      title: "The Modern Agency",
      tagline: "Rebranding to Manzarkash, managing global client campaigns.",
      desc: "Consolidating our visual production, custom engineering, search positioning, and automated software workflows, we became Manzarkash. Today, we deliver unified, full-stack brand acceleration to retail partners across Pakistan, the Gulf, and Europe.",
      achievements: [
